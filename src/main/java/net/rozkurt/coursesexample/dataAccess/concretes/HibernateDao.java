 ...
 */
public class HibernateDao implements Dao<Entity, Integer>{
    ...
    public HibernateDao(String daoName) {
    ...
    public void add(Entity c) {
        listOfEntity.add(c);
        System.out.println("'"+c.getEntityName() +"' added at '" + c.getTableName() + "' table with '" + daoName +"'");
    }
